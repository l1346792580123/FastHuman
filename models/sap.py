...
import torch.fft
# code borrowed from shape-as-points https://github.com/autonomousvision/shape_as_points
...
def gen_inputs(mesh_name, num_sample=10000):
